                ...
                <div className="container">
                    <div className="grid">
                        <div className="row">
                            <div className="col">
                                <p className="h3"> 
                                Contact Manager <Link to={'/contacts/add'} className="btn btn-primary ms-2"> 
                                <i className="fa fa-plus-circle me-2"/>New </Link>
                                </p>
                                <p className="fst-italic"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum molestias explicabo aut. Architecto deserunt incidunt sapiente eum animi, nulla reprehenderit nobis similique, consectetur, obcaecati excepturi veniam voluptates? Accusamus, assumenda quisquam? </p>
                            </div>
                        </div>
                        <div className="row">
